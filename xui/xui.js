class Element {
  ...
  on(eventName, handler) {
    ...
    if (existingAttr) {
      ...
      this.attribs[`on${eventName}`] =
        `(${oldHandler})(event); (${handler})(event);`;
    } else {
  ...
  addClass(className) {
    const currentClasses = this.attribs.class
      ? this.attribs.class.split(" ")
      : [];
...
class StyleManager {
  ...
  apply(element, ruleName) {
    const fullRuleName = ruleName.startsWith(this.prefix)
      ? ruleName
      : this.prefix + ruleName;
  ...
  unapply(element, ruleName) {
    ...
    if (element instanceof Element) {
      ...
      element.attr(
        "class",
        classes.replace(new RegExp(`\\b${fullRuleName}\\b`, "g"), "").trim(),
      );
    }
    return element;
  }
  ...
  applyAnimation(
    ...
    const fullAnimName = animName.startsWith(`${this.prefix}anim-`)
      ? animName
      : `${this.prefix}anim-${animName}`;
  ...
  set(updates) {
    ...
    for (const [key, value] of Object.entries(updates)) {
      if (prevState[key] !== value && this.listeners[`change:${key}`]) {
        this.listeners[`change:${key}`].forEach((listener) =>
          listener(value, prevState[key]),
        );
      }
    }
...
class XWUI {
  ...
  find(selector) {
    if (selector.startsWith("#")) {
      return (
        this.elements.find(
          (elem) => elem.attribs.id === selector.substring(1),
        ) || null
      );
      ...
      return (
        this.elements.find((elem) => {
          const classes = elem.attribs.class
...
class ElementFactories {
  ...
  div(attribs, ...children) {
    return this.create("div", attribs, ...children);
  }
  span(attribs, ...children) {
    return this.create("span", attribs, ...children);
  }
  p(attribs, ...children) {
    return this.create("p", attribs, ...children);
  }
  h1(attribs, ...children) {
    return this.create("h1", attribs, ...children);
  }
  h2(attribs, ...children) {
    return this.create("h2", attribs, ...children);
  }
  h3(attribs, ...children) {
    return this.create("h3", attribs, ...children);
  }
  h4(attribs, ...children) {
    return this.create("h4", attribs, ...children);
  }
  h5(attribs, ...children) {
    return this.create("h5", attribs, ...children);
  }
  h6(attribs, ...children) {
    return this.create("h6", attribs, ...children);
  }
  ul(attribs, ...children) {
    return this.create("ul", attribs, ...children);
  }
  ol(attribs, ...children) {
    return this.create("ol", attribs, ...children);
  }
  li(attribs, ...children) {
    return this.create("li", attribs, ...children);
  }
  a(attribs, ...children) {
    return this.create("a", attribs, ...children);
  }
  img(attribs) {
    return this.create("img", attribs);
  }
  button(attribs, ...children) {
    return this.create("button", attribs, ...children);
  }
  input(attribs) {
    return this.create("input", attribs);
  }
  textarea(attribs, ...children) {
    return this.create("textarea", attribs, ...children);
  }
  form(attribs, ...children) {
    return this.create("form", attribs, ...children);
  }
  table(attribs, ...children) {
    return this.create("table", attribs, ...children);
  }
  tr(attribs, ...children) {
    return this.create("tr", attribs, ...children);
  }
  td(attribs, ...children) {
    return this.create("td", attribs, ...children);
  }
  th(attribs, ...children) {
    return this.create("th", attribs, ...children);
  }
  thead(attribs, ...children) {
    return this.create("thead", attribs, ...children);
  }
  tbody(attribs, ...children) {
    return this.create("tbody", attribs, ...children);
  }
  footer(attribs, ...children) {
    return this.create("footer", attribs, ...children);
  }
  header(attribs, ...children) {
    return this.create("header", attribs, ...children);
  }
  section(attribs, ...children) {
    return this.create("section", attribs, ...children);
  }
  article(attribs, ...children) {
    return this.create("article", attribs, ...children);
  }
  nav(attribs, ...children) {
    return this.create("nav", attribs, ...children);
  }
  aside(attribs, ...children) {
    return this.create("aside", attribs, ...children);
  }
  main(attribs, ...children) {
    return this.create("main", attribs, ...children);
  }
}
...
class Component {
  constructor(app, options = {}) {
    ...
    this.id =
      options.id ||
      `component-${Date.now()}-${Math.floor(Math.random() * 1000)}`;
  }
